...
export default function ViewRegister() {
  return (
    <PageContainer>
      ...
      <View style={{ gap: 12 }}>
        <View>
          <Typography style={{ fontSize: 32 }}>Responsável</Typography>
        ...
        <View>
          ...
          >
            <Tag icon="airplay" color="pink" label="Foco" variant="active" />
            <Tag
              icon="airplay"
              color="pink"
              label="Agitação"
            ...
            <Tag
              ...
              variant="inactive"
            />
            <Tag icon="airplay" color="pink" label="Gritos" variant="active" />
            <Tag
              icon="airplay"
              color="pink"
              label="Comportado"
