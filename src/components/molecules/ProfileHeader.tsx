...
export function ProfileHeader({nameColor, profileColor = 'white'}: {nameColor?: Colors, profileColor?: Colors  }) {
    return (
        <View style={{margin: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 12}}>
            <Profile uri='https://github.com/diego3g.png' color={profileColor} size={96}/>
